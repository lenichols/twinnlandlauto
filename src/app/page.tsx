    ...
    <>
      ...
      <section className="bg-center bg-no-repeat bg-[url('/images/openroadbkg.png')] bg-white bg-blend-luminosity bg-opacity-10">
        ...
        <div className="w-max mx-auto">
          <h1
            className="animate-typing overflow-hidden lg:overflow-hidden whitespace-normal md:whitespace-normal lg:whitespace-nowrap border-r-4 border-r-white text-xl md:text-5xl lg:text-6xl text-orange-500 text-center font-bold py-4 text-shadow-md">
